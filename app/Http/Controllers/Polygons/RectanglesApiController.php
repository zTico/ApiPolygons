...
{
    public function createRectangle(Request $request): array
    {
        try {
            $result = ['sucess' => true];
    ...
    public function readAllRectangles(): array
    {
        try {
            $result = ['sucess' => true];
    ...
    public function readRectangle(Request $request): array
    {
        try {
            $result = ['sucess' => true];
    ...
    public function updateRectangle(Request $request): array
    {   
        try {
            $result = ['sucess' => true];
    ...
    public function deleteRectangle(request $request): array
    {
        try {
            $result = ['sucess' => true];
            $rectangle = Rectangle::find($request->id);
